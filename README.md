...
Add `[lein-fregec "3.23.450"]` to `:plugins` in your `project.clj`. The version of `lein-fregec` matches the version of the Frege compiler it is compatible with and uses.
...
```clojure
:dependencies [[org.frege-lang/frege "3.23.450-SNAPSHOT]]
```
